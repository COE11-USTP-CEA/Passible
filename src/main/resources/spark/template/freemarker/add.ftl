...
<div class="row jumbotron" style="background-color:rgba(0, 0, 0, 0.5);">
  ...
  <font color="powderblue"><h2>Add Your Contact</h2></font>
  </div>
...
<div class="col-md-4"></div>
  ...
  <form method = "post" action="/submit">
    ...
    <font color="powderblue"><label for="exampleInputCode">Your Name</label> </font>
      <input type="code" name="code" class="form-control" id="item_code" placeholder="name nimu biss">
    </div>
    <div class="form-group">
     <font color="powderblue"> <label for="exampleInputName">Your Email</label> </font>
      <input type="name" name="name" class="form-control" id="item_name" placeholder="melowjean@example.com">
    </div>
    <div class="form-group">
     <font color="powderblue"> <label for="exampleInputName">Your Number</label> </font>
      <input type="num" name="number" class="form-control" id="item_number" placeholder="09xxxxxxxxx">
    </div>
     <div class="form-group">
      <font color="powderblue"><label for="exampleInputName">Your Web</label> </font>
      <input type="web" name="web" class="form-control" id="item_number" placeholder="Enter your IP address">
    </div>
